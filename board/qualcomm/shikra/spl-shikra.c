...
#define SHIKRA_SPL_DDR_BASE_2       0x880000000UL
#define SHIKRA_SPL_DDR_SIZE_2       0x780000000UL
...
static struct mm_region shikra_spl_mem_map[] = {
	{
		...
		.virt = SHIKRA_SPL_DDR_BASE_2,
		.phys = SHIKRA_SPL_DDR_BASE_2,
		.size = SHIKRA_SPL_DDR_SIZE_2,
		.attrs = PTE_BLOCK_MEMTYPE(MT_NORMAL_NC) |
			 PTE_BLOCK_INNER_SHARE,
	}, {
		0,
